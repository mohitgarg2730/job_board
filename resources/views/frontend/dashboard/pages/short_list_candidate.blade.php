    ...
    <div class="dashboard-tlbar d-block mb-4">
        <div class="row">
            <div class="colxl-12 col-lg-12 col-md-12">
                <h1 class="mb-1 fs-3 fw-medium">Shortlisted vacancies</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item text-muted"><a href="#">Candidate</a></li>
                        <li class="breadcrumb-item text-muted"><a href="#">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#" class="text-primary">Shortlisted vacancies</a></li>
                    </ol>
                </nav>
            </div>
        </div>
                                ...
                                <div class="jbs-list-box border">
                                    <div class="jbs-list-head mb-0">
                                        ...
                                        <div class="jbs-list-head-last">
                                            ...
                                            <a href="job-detail.html" class="btn btn-md btn-light-primary px-3">view details</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="jbs-list-head mb-0">
                                        <div class="jbs-list-head-thunner">
                                            ...
                                            <div class="jbs-list-job-caption">
                                                ...
                                                <div class="jbs-job-mrch-lists">
                                                    <div class="single-mrch-lists">
                                                        <span>Dribble</span>.<span><i class="fa-solid fa-location-dot me-1"></i>New York, VS</span>.<span>7 March 2023</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="jbs-list-head mb-0">
                                        <div class="jbs-list-head-thunner">
                                            ...
                                            <div class="jbs-list-job-caption">
                                                ...
                                                <div class="jbs-job-mrch-lists">
                                                    <div class="single-mrch-lists">
                                                        <span>Skype</span>.<span><i class="fa-solid fa-location-dot me-1"></i>Canada, VS</span>.<span>10 March 2022</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
